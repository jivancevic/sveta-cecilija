...
- The "one task" framing means a dancer who sets only a password reads as incomplete on the roster even though they can now sign in on any phone. Deliberate: two half-signals on seventy-six rows is worse than one honest one.
