...
1. **To a cold tourist, moreska.eu is not yet the surfaced answer anywhere.** The old domain + aggregators (visitkorcula.eu, TripAdvisor) and the competitor (moreska.hr) own the AI-citation space today. This matches `marketing.md`'s premise — and confirms the GEO gap is real and winnable.
