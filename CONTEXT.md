...
It is the word this project uses, deliberately **not** *otkazivanje*: in Cecilija *otkazati* is what happens to an izvedba, with refunds behind it, and a dancer and an evening must never share that verb. Read on *Stanje* as **Odustali**, its own list above *Bez odgovora* and disjoint from *Ne dolaze*, which holds only those who never promised anything. Since #609 it replaces a push: nobody's phone rings for it.
