...
| Cecilija, the staff and member app (`/app`, called Moreškant until #489) — route group, shared cookie, access decision, roster loaders, PWA | `docs/agents/moreskant-app.md` (+ [ADR-0024](docs/adr/0024-moreskant-roster-domain.md)) |
