...
// `inviteAllActionVisible` was asserted here until #651 (ADR-0028) retired the
// bulk invitation: the letter goes to the login's own address now, and a dancer
// with no login has no address anywhere, so the action had nobody to write to.
