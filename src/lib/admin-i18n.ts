...
export const dashboardStrings = {
  en: {
    ...
    confirmCancelTicket: 'Cancel ticket?',
    confirmYes: 'Yes',
    confirmNo: 'No',
  ...
  hr: {
    ...
    confirmCancelOrder: 'Otkazati narudžbu?',
    confirmCancelTicket: 'Otkazati ulaznicu?',
    confirmYes: 'Da',
    confirmNo: 'Ne',
