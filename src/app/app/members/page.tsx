...
//
// The rehearsal half sits at the top — the join code and the queue under it are
// what a voditelj opens this screen for while standing in a hall, and the
// roster is what they open it for at home. Everything below the queue is the
// list: search, a row per moreškant, the profile behind each row.
//
...
export default async function MembersPage() {
  ...
  return (
    <AppShell viewer={viewer} screen="members">
      <JoinCodeCard
